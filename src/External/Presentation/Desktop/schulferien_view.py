...
class SchulferienView(QWidget):
    def __init__(
        self, view_model: SchulferienViewModel, parent: QWidget | None = None
    ) -> None:
    ...
    def _build_ui(self) -> None:
        ...
        self._import_button = QPushButton("Import vom Internet starten", self)
        ...
        self._form_group = QGroupBox("Neue Schulferien", self)
        ...
        self._name_input.setPlaceholderText("z. B. Sommerferien")
        ...
        self._speichern_button = QPushButton("Schulferien speichern", self)
    ...
    def _form_enthaelt_gespeicherte_zeile(self, row: SchulferienRow) -> bool:
        return (
    ...
    def _aktualisiere_formular_titel(self) -> None:
        if self._bearbeitungs_id is not None:
            self._form_group.setTitle("Schulferien editieren")
            ...
            self._form_group.setTitle("Neue Schulferien")
            self._form_group.setStyleSheet(
                "QGroupBox {"
    ...
    def _zeile_ins_formular(self, row: SchulferienRow) -> None:
    ...
    def _show_error(self, message: str) -> None:
        QMessageBox.warning(self, "Schulferien", message)
