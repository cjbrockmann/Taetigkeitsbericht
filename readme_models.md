...
Domain-Modelle unter `src/Core/Domain/models/entities/` (einzelne Dateien pro Entität). Re-Export für bestehenden Code: `models_worktime.py` und `Core.Domain.models`.

Felder mit „optional“ / „nein“ dürfen leer (`None`) bleiben; `id` wird von der Datenbank vergeben, sofern nicht anders angegeben.
